...
```javascript
reim = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-reim@v0.1.4-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-reim@v0.1.4-umd/browser.js"></script>
```
